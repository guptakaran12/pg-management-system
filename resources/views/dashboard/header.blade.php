    ...
    <div class="header-user">
        <div class="nav user-menu">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="pe-1">
                    <div class="dropdown">
                        <a href="#" class="btn btn-outline-light bg-white btn-icon me-1" data-bs-toggle="dropdown"
                            aria-expanded="false">
                ...
                <div class="pe-1" id="notification_item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
                        <div class="d-flex align-items-center justify-content-between border-bottom p-0 pb-3 mb-3">
                            <h4 class="notification-title">{{ asset('Notifications') }} (2)</h4>
                            <div class="d-flex align-items-center">
                                <a href="#"
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="border-bottom mb-3 pb-3">
                                    <a href="activities.html" class="pb-0">
                                        <div class="d-flex">
                                            <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                <img src="{{ asset('assets/img/profiles/avatar-23.jpg') }}"
                                                    alt="Profile">
                                            </span>
                                            <div class="flex-grow-1">
                    ...
                    <div class="dropdown-menu" style="">
                        <div class="d-block">
                            ...
                            <a class="dropdown-item d-inline-flex align-items-center p-2"
                                href="profile-settings.html"><i
                                    class="ti ti-settings me-2"></i>{{ __('Settings') }}</a>
                            <hr class="m-0">
                            <a class="dropdown-item d-inline-flex align-items-center p-2"
                                href="{{ route('logout') }}"><i class="ti ti-login me-2"></i>{{ __('Logout') }}</a>
                        </div>
                    </div>
                </div>
            </div>
