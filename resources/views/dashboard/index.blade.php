        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    ...
                    <div class="mb-2">
                        <a href="collect-fees.html.htm" class="btn btn-light d-flex align-items-center">{{ __('User Details') }}</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                            ...
                            <div class="d-flex align-items-xl-center justify-content-xl-between flex-xl-row flex-column">
                                <div class="mb-3 mb-xl-0">
                                    <div class="d-flex align-items-center flex-wrap mb-2">
                                        <h1 class="text-white me-2">Welcome Back,{{ Auth::user()->full_name ?? "" }}</h1>
                                ...
                                <div class="border-start border-skyblue border-3 shadow-sm p-3 mb-3">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="d-flex align-items-center"><i class="ti ti-calendar me-1"></i>15
                                                July 2024</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="border-start border-danger border-3 shadow-sm p-3 mb-3">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="d-flex align-items-center"><i class="ti ti-calendar me-1"></i>07
                                                July 2024 - 07 July 2024</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="students">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="student-attendance.html.htm" class="btn btn-light"><i
                                ...
                                <div class="tab-pane fade" id="teachers">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="teacher-attendance.html.htm" class="btn btn-light"><i
                                                class="ti ti-calendar-share me-1"></i>View All</a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="staff">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="staff-attendance.html.htm" class="btn btn-light"><i
                                                class="ti ti-calendar-share me-1"></i>View All</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body pb-1">
                            <div class="owl-carousel link-slider">
                                <div class="item">
                                    <a href="class-time-table.html.htm"
                                ...
                                <div class="item">
                                    ...
                                    <a href="class-home-work.html.htm"
                                ...
                                <div class="item">
                                    <a href="student-attendance.html.htm"
                                    ...
                                    <a href="attendance-report.html.htm"
                            ...
                            <div class="d-md-flex align-items-center justify-content-between">
                                <div class="me-md-3 mb-3 mb-md-0 w-100">
                                    <div
                                        ...
                                        <p class="mb-0 me-2"><i
                                                class="ti ti-arrow-badge-down-filled me-2 text-primary"></i>Top
                                        </p>
                                        <h5>45</h5>
                                    </div>
                                    <div
                                    ...
                                    <div
                                        ...
                                        <p class="mb-0 me-2"><i
                                                class="ti ti-arrow-badge-down-filled me-2 text-danger"></i>Below
                                            Avg
                                        </p>
                                        <h5>02</h5>
                                    </div>
                            ...
                            <div class="card mb-2">
                                <div class="card-body p-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                        <p class="mb-0">Leave : <span class="fw-semibold">12 -13 May</span>
                                        </p>
            ...
            <div class="row">
                ...
                <!-- Links -->
                <div class="col-xl-3 col-md-6 d-flex">
                    <a href="membership-plans.html.htm"
                ...
                <div class="col-xxl-5 col-xl-12 order-3 order-xxl-2 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header  d-flex align-items-center justify-content-between">
                            ...
                            <a href="notice-board.html.htm" class="fw-medium">View All</a>
                        </div>
                        <div class="card-body">
